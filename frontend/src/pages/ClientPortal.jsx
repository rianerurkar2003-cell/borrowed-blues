    ...
    <div className="min-h-screen bg-bb-cream flex" data-testid="client-portal">
      <aside className="w-[248px] shrink-0 hidden md:flex flex-col border-r border-bb-moss/60 bg-bb-warm px-6 py-8">
        <Link to="/" className="flex items-center gap-3 mb-10">
          <svg width="30" height="30" viewBox="0 0 40 40"><path d="M6 22 Q20 4 34 22" stroke="#1C3829" strokeWidth="2" fill="none"/><path d="M10 24 Q20 12 30 24" stroke="#4A7C78" strokeWidth="2" fill="none"/></svg>
          <div className="leading-tight">
            <p className="font-serif text-[15px] text-bb-forest">Borrowed</p>
            <p className="font-serif italic text-[13px] text-bb-teal -mt-1">Blues</p>
          </div>
        </Link>
